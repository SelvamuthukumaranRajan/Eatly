...
public class GetAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        SharedPrefsUtils.putString(SharedPrefsUtils.PREF_KEY.shareLatitude,String.valueOf(location.getLatitude()));
        SharedPrefsUtils.putString(SharedPrefsUtils.PREF_KEY.shareLongitude,String.valueOf(location.getLongitude()));
        try {
        ...
        if (addresses == null || addresses.size() == 0) {
            ...
            SharedPrefsUtils.putString(SharedPrefsUtils.PREF_KEY.shareLocation,address.getSubAdminArea());
        }
    }
