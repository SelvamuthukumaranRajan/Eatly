...
public class CurrentAddress  extends AppCompatActivity {
    ...
    private void getAddress() {
        ...
        if (!Geocoder.isPresent()) {
            Toast.makeText(CurrentAddress.this,
    ...
    private void showResults(String currentAdd) {
        SharedPrefsUtils.putString(SharedPrefsUtils.PREF_KEY.shareCurrentLocation,currentAdd);
        if (!SharedPrefsUtils.getBoolean(SharedPrefsUtils.PREF_KEY.shareLoginStatus))
        {
            SharedPrefsUtils.putString(SharedPrefsUtils.PREF_KEY.homeAddress,currentAdd);
        }
        Navigation(CurrentAddress.this, Login.class);
    }
